...
gcc_pure
static inline double ComputeNoncompVario(const double pressure, const double d_pressure)
{
...
bool BaroMS561101BADevice::ParsePRS(const char *content, NMEAInfo &info)
{
  // e.g. PRS 17CBA
...
static bool ParseUlong(const char **line, unsigned long &value)
{
  char *endptr;
...
/**
 * Parse the BaroMS561101BA Vario version.
 * Sent Upon a BST request.
 */
bool BaroMS561101BADevice::ParseBFV(const char *content, NMEAInfo &info)
{
  // e.g. BFV 9
...
/**
 * Parse the BaroMS561101BA Vario parameter list.
 * Sent Upon a BST request.
 */
bool BaroMS561101BADevice::ParseBST(const char *content, NMEAInfo &info)
{
...
/**
 * Parse the BaroMS561101BA Vario parameter values.
 * Sent Upon a BST request.
 */
bool BaroMS561101BADevice::ParseSET(const char *content, NMEAInfo &info)
{
...
bool BaroMS561101BADevice::ParseNMEA(const char *line, NMEAInfo &info)
{
